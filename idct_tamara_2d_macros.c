...
#define BUTTERFLY(cx0, cx1, cx2, cx3,var0,var1,var2,var3) do {\
	     var0 = cx0 + cx3;\
	     var1 = cx1 + cx2;\
	     var2 = cx1 - cx2;\
	     var3 = cx0 - cx3;\
...
#define REVERSETRANSFORM(vt0,vt1,vt2,vt3,var0,var1,var2,var3) do {\
		var0 = vt0 + vt2;\
		var1 = vt0 - vt2;\
		var0 += (var0 >> 2);\
		var1 += (var1 >> 2);\
...
#define RECOVER(vI0,vI1,vI2,vI3,var0,var1,var2,var3) do {\
		r0 = (vI0 + vI3)/10;\
		r1 = (vI1 + vI2)/10;\
		r2 = (vI1 - vI2)/10;\
		r3 = (vI0 - vI3)/10;\
...
main(int argc, char *argv[]) {
	...
	{ // traverse width		
		...
		for (j = 0; j <y; j +=4)
		{
			...
			//TRANSFORM(i12,i13,i14,i15,t12,t13,t14,t15);
			...
			REVERSETRANSFORM(t4,t5,t6,t7,I4,I5,I6,I7);
			//REVERSETRANSFORM(t8,t9,t10,t11,I8,I9,I10,I11);
			//REVERSETRANSFORM(t12,t13,t14,t15,I12,I13,I14,I15);

			//need to think about how to "unrotate" the matrix for recovery	
			//recover values from 2D to 1D

			//RECOVER(I0,I1,I2,I3,r0,r1,r2,r3);
			RECOVER(I4,I5,I6,I7,r4,r5,r6,r7);
			//RECOVER(I8,I9,I10,I11,r8,r9,r10,r11);
			//RECOVER(I12,I13,I14,I15,r12,r13,r14,r15);
